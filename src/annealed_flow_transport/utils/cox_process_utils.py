...
def gram(kernel, xs: jax.Array) -> jax.Array:
...
def kernel_func(x: jax.Array,
                y: jax.Array,
                signal_variance: jax.Array,
                num_grid_per_dim: int,
                raw_length_scale: jax.Array) -> jax.Array:
...
def poisson_process_log_likelihood(latent_function: jax.Array,
                                   bin_area: jax.Array,
                                   flat_bin_counts: jax.Array) -> jax.Array:
...
def get_latents_from_white(white: jax.Array, const_mean: jax.Array,
                           cholesky_gram: jax.Array) -> jax.Array:
...
def get_white_from_latents(latents: jax.Array,
                           const_mean: jax.Array,
                           cholesky_gram: jax.Array) -> jax.Array:
